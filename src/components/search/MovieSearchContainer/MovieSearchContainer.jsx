...
const MovieSearchContainer = () => {
  ...
  const nominationLoadingStatus = useSelector(
    (state) => state.nominate.loading,
  );
  const nominationsCompleted = useSelector(
    (state) => state.nominate.nominationsCompleted,
  );
